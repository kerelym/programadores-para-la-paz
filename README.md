...
Este repositorio reúne las actividades, ejercicios y proyectos desarrollados durante el programa **Programadores para la Paz**, enfocado en fortalecer habilidades de ciudadanía digital, pensamiento lógico, programación y desarrollo web.

El objetivo es documentar el progreso realizado semana a semana mediante prácticas técnicas, ejercicios guiados y proyectos aplicados utilizando herramientas modernas de desarrollo.
...
```bash
cd programadores-para-la-paz
```

### 3. Acceder a una semana específica
